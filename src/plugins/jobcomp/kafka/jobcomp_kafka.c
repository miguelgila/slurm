 ...
 *
 *
 *  Produced at CSCS the Swiss National Supercomputing Centre.
 *  Written by Miguel Gila <miguel.gila@cscs.ch>, who borrowed heavily
 *  from jobcomp/filetxt and jobcomp/elasticsearch.
 *
 ...
 * matures.
 */
const char plugin_name[] = "Job completion kafka logging plugin";
...
char *save_state_file = "kafka_state";
